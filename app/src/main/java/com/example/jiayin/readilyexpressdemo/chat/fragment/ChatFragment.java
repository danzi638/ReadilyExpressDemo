package com.example.jiayin.readilyexpressdemo.chat.fragment;
    ...
    protected void initView() {
        ...
        setConversationListItemClickListener(new EaseConversationListFragment.EaseConversationListItemClickListener() {
            ...
            public void onListItemClicked(EMConversation conversation) {
                Log.d(TAG, "onListItemClicked: " + "跳转到回话详情页面");
                Toast.makeText(getActivity(),"跳转到回话详情页面",Toast.LENGTH_SHORT).show();
